...
public class EvaluatorIE {
	...
	public void printMatrix(int[] scores) {
		System.out.println("CORRECT: " + scores[EvaluatorIE.CORRECT]);
		System.out.println("SUBSTITUTION: " + scores[EvaluatorIE.SUBSTITUTION]);
		System.out.println("INSERTION: " + scores[EvaluatorIE.INSERTION]);
		System.out.println("DELETION: " + scores[EvaluatorIE.DELETION]);
	}
